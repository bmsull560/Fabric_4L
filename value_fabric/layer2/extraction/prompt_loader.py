...
def render_entity_prompt(
    entity_type: str, text: str, confidence_threshold: float = 0.8, **extra_vars
) -> str:
    ...
    return template.render(text=text, confidence_threshold=confidence_threshold, **extra_vars)


def render_relationship_prompt(text: str, entities: dict[str, list[Any]], **extra_vars) -> str:
    ...
    return template.render(text=text, entities_json=json.dumps(entity_list, indent=2), **extra_vars)
