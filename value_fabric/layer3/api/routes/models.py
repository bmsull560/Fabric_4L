...
def _internal_error_detail() -> dict[str, str]:
    """Contract-safe internal error payload."""
    return {"code": "internal_error", "message": "Internal server error"}


def _log_database_exception(operation: str, ctx: RequestContext, exc: Exception) -> None:
    """Log full exception context including tenant and request trace IDs."""
    logger.exception(
        "Layer3 models database operation failed",
        extra={
            "context": {
                "operation": operation,
...
async def list_models(
    ...
    async with await create_neo4j_tenant_session(current_tenant) as neo4j:
        ...
        try:
            ...
            _log_database_exception("list_models", ctx, e)
...
async def get_folder_counts(
    ...
    async with await create_neo4j_tenant_session(current_tenant) as neo4j:
        ...
        try:
            ...
            _log_database_exception("get_folder_counts", ctx, e)
            raise HTTPException(status_code=500, detail=_internal_error_detail())
...
async def get_model_detail(
    ...
    async with await create_neo4j_tenant_session(current_tenant) as neo4j:
        try:
            ...
            _log_database_exception("get_model_detail", ctx, e)
            raise HTTPException(status_code=500, detail=_internal_error_detail())
...
async def create_model(
    ...
    async with await create_neo4j_tenant_session(current_tenant) as neo4j:
        ...
        try:
            ...
            _log_database_exception("create_model", ctx, e)
            raise HTTPException(status_code=500, detail=_internal_error_detail())
...
async def delete_model(
    ...
    async with await create_neo4j_tenant_session(current_tenant) as neo4j:
        ...
        try:
            ...
            _log_database_exception("delete_model", ctx, e)
            raise HTTPException(status_code=500, detail=_internal_error_detail())
>>>>>>> theirs
