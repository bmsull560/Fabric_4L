...
class PredicateType(str, Enum):
    ...
    CAPABILITY_REQUIRES_CAPABILITY = "capability_requires_capability"  # Capability → Capability (dependency)
...
class Relationship(BaseModel):
    ...
    Attributes:
        ...
        predicate: Type of relationship (enables, benefits, etc.)
    ...
    def get_inverse(self) -> "Relationship":
        ...
        if self.predicate in inverse_predicates:
            return Relationship(
                source_id=self.target_id,
                predicate=inverse_predicates[self.predicate],
...
class RelationshipGraph(BaseModel):
    ...
    def add_relationship(self, rel: Relationship) -> None:
        ...
        if not self.has_relationship(rel.source_id, rel.predicate, rel.target_id):
