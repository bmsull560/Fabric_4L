...
class JobCostSummary(BaseModel):
    ...
    def add_cost_record(self, record: ExtractionCost) -> None:
        ...
        self.provider_breakdown[provider] = self.provider_breakdown.get(provider, 0.0) + record.cost_usd
        
        # Update endpoint breakdown
        endpoint = record.endpoint
        self.endpoint_breakdown[endpoint] = self.endpoint_breakdown.get(endpoint, 0.0) + record.cost_usd
