...
class CheckpointConfig:
    ...
    @classmethod
    async def close_saver(cls, saver: Optional[AsyncPostgresSaver]) -> None:
...
async def get_checkpoint_saver() -> Optional[BaseCheckpointSaver]:
    ...
    try:
        ...
        logger.warning(f"Checkpointing unavailable due to unexpected error: {type(e).__name__}: {e}")
        return None
