...
class GetProspectDataTool(BaseTool):
    ...
    async def _get_salesforce_data(self, client: httpx.AsyncClient, input_data: GetProspectDataInput) -> GetProspectDataOutput:
    ...
    async def _get_hubspot_data(self, client: httpx.AsyncClient, input_data: GetProspectDataInput) -> GetProspectDataOutput:
...
class FetchInteractionHistoryTool(BaseTool):
    ...
    async def execute(self, input_data: FetchInteractionHistoryInput) -> FetchInteractionHistoryOutput:
    ...
    async def _get_salesforce_interactions(self, client: httpx.AsyncClient, input_data: FetchInteractionHistoryInput) -> FetchInteractionHistoryOutput:
    ...
    async def _get_hubspot_interactions(self, client: httpx.AsyncClient, input_data: FetchInteractionHistoryInput) -> FetchInteractionHistoryOutput:
    ...
    def _generate_summary(self, interactions: List[Dict]) -> str:
        ...
        parts = [f"Recent activity: {meeting_count} meetings, {email_count} emails, {call_count} calls"]
