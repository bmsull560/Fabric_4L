...
class CrawlerConfig:
    ...
    blocked_resource_patterns: List[str] = field(default_factory=lambda: [
    ...
    trace_attributes: dict = field(default_factory=lambda: {
...
def load_config(path: Optional[Path | str] = None) -> CrawlerConfig:
