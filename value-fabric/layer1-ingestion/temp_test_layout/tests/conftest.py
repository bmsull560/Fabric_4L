...
if src_path not in sys.path:
    # sys.path.insert(0, src_path) # DISABLED FOR VALIDATION
...
os.environ["PYTHONPATH"] = "" + os.pathsep # src_path removed for validation + shared_root + os.pathsep + os.environ.get("PYTHONPATH", "")
