"""Energy & Utilities Value Pack - Integrity Tests
...
class TestPackManifest:
    ...
    def test_workflow_has_pack_id(self, pack_files):
        ...
        assert pack_files["workflow_template"]["pack_id"] == "energy-utilities-v1"
