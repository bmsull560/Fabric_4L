...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(20), nullable=False, default='pending', comment="Lifecycle status"),
        sa.Column('settings', sa.JSON(), nullable=False, default=lambda: {"isolation_tier": "shared"}, comment="Tenant configuration"),
    ...
    op.create_table(
        ...
        sa.Column('role', sa.String(30), nullable=False, default='analyst'),
    ...
    op.create_table(
        ...
        sa.Column('tenant_id', sa.String(100), nullable=False, default='default', comment="Tenant identifier for RLS"),
        sa.Column('opportunities', sa.JSON(), nullable=False, default=list, comment="Embedded opportunities"),
        sa.Column('contacts', sa.JSON(), nullable=False, default=list, comment="Embedded contacts"),
        sa.Column('enrichment_status', sa.String(20), nullable=False, default='pending'),
        sa.Column('enriched_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('enrichment_sources', sa.JSON(), nullable=False, default=list),
        sa.Column('tech_stack', sa.JSON(), nullable=True),
        sa.Column('executives', sa.JSON(), nullable=False, default=list),
        sa.Column('financials', sa.JSON(), nullable=True),
        sa.Column('competitive_landscape', sa.JSON(), nullable=False, default=list),
        sa.Column('pain_signals', sa.JSON(), nullable=False, default=list),
    )
    ...
    op.create_table(
        'account_sync_status',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('tenant_id', sa.String(100), nullable=False, default='default'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(50), nullable=False, index=True, default='draft'),
        sa.Column('currency', sa.String(3), nullable=False, default='USD'),
        sa.Column('subtotal', sa.BigInteger(), nullable=False, default=0),
        ...
        sa.Column('amount_due', sa.BigInteger(), nullable=False, default=0),
    ...
    op.create_table(
        ...
        sa.Column('quantity', sa.Numeric(precision=20, scale=8), nullable=False, default=1.0),
        ...
        sa.Column('discount_amount', sa.BigInteger(), nullable=False, default=0),
        sa.Column('metadata', postgresql.JSONB(), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(50), nullable=False, index=True, default='pending'),
        sa.Column('amount', sa.BigInteger(), nullable=False),
        sa.Column('currency', sa.String(3), nullable=False, default='USD'),
    ...
    op.create_table(
        ...
        sa.Column('sync_batch_size', sa.Integer(), nullable=False, default=100),
        sa.Column('last_sync_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('last_successful_sync_at', sa.DateTime(timezone=True), nullable=True),
        ...
        sa.Column('sync_status', sa.String(50), default='idle', nullable=False),
