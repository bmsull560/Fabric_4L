...
def calculate_roi(
    ...
    trace: List[Dict[str, Any]] = [
        ...
        {"step": "total_benefit", "value": total_benefit, "note": "revenue_uplift + cost_savings + risk_reduction"},
        {"step": "net_benefit", "value": net_benefit, "note": "total_benefit - solution_cost"},
        {"step": "roi_percent", "value": round(roi_percent, 2), "note": "(net_benefit / solution_cost) * 100"},
        {"step": "payback_months", "value": round(payback_months, 2), "note": "solution_cost / (total_benefit / 12)"},
    ]
