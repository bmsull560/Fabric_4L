...
@router.post("/hypotheses/generate", response_model=ValueHypothesis)
async def generate_hypothesis(account_id: str, hypothesis: ValueHypothesis, tenant_id: str = Depends(tenant_required)):
...
async def update_hypothesis(hypothesis_id: str, fields: dict, tenant_id: str = Depends(tenant_required)):
