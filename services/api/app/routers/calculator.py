...
from app.models.schemas import Scenario, ROICalculation
...
async def create_scenario(account_id: str, scenario: Scenario, tenant_id: str = Depends(tenant_required)):
...
async def run_roi_calculation(account_id: str, payload: dict, tenant_id: str = Depends(tenant_required)):
