...
## Phase A: Repo-Root Collection Errors (current state - 34 errors)
...
| 27 | services/layer2-extraction/tests/test_extract_and_ingest_pipeline.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
| 28 | services/layer2-extraction/tests/test_extraction.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
| 29 | services/layer2-extraction/tests/test_llm_cost_metrics.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
| 30 | services/layer2-extraction/tests/test_llm_extractor.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
| 31 | services/layer2-extraction/tests/test_ontology_alignment.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
| 32 | services/layer2-extraction/tests/test_sse_streaming.py | ModuleNotFoundError: No module named 'layer2_extraction' | layer2 import topology | Package not in PYTHONPATH or not configured as namespace package | Add layer2 to value_fabric namespace, migrate imports |
...
| 38 | services/layer4-agents/tests/test_oidc_cleanup.py | ImportError | unknown (needs investigation) | Unknown (needs investigation) | Investigate and fix |
| 39 | services/layer4-agents/tests/test_usage_idempotency.py | ImportError | unknown (needs investigation) | Unknown (needs investigation) | Investigate and fix |
| 40 | services/layer4-agents/tests/test_usage_service.py | ImportError | unknown (needs investigation) | Unknown (needs investigation) | Investigate and fix |
| 41 | tests/agents/test_conversation_service.py | ModuleNotFoundError: No module named 'services.conversation' | stale value-fabric path | Test imports from `services.conversation` instead of canonical package | Migrate to canonical import |
...
| 43 | tests/context/test_tenant_context_contract.py | ImportError: cannot import name 'get_tenant_context' | shared namespace issue | get_tenant_context not exported from value_fabric.shared.identity.context | Add export or fix import |
| 44 | tests/contracts/test_entity_contract.py | ModuleNotFoundError: No module named 'api.models' | stale value-fabric path | Test imports from `api.models` instead of canonical package | Migrate to canonical import |
| 45 | tests/security/test_p0_5_api_key_rejection.py | ImportError: cannot import name 'reject_api_key_with_error' | shared namespace issue | Function not exported from value_fabric.shared.identity.api_key_stub | Add export or fix import |
...
| 47 | tests/test_tenant_rate_limiting.py | ImportError: cannot import name 'get_tenant_context' | shared namespace issue | get_tenant_context not exported from value_fabric.shared.identity.context | Add export or fix import |
...
### Summary by Classification (Repo-Root)

**Layer 1 import topology (0):** - No import topology errors, all are missing dependencies
**Layer 2 import topology (6):** - BLOCKED
- All layer2-extraction tests importing from `layer2_extraction`

**Layer 3 import topology (1):** - BLOCKED
- test_tenant_isolation.py: relative import beyond top-level package

**Layer 4 import topology (1):** - BLOCKED
- test_tool_result_contract.py: relative import beyond top-level package

**Shared namespace issue (3):** - BLOCKED
- test_tenant_context_contract.py: cannot import get_tenant_context
- test_p0_5_api_key_rejection.py: cannot import reject_api_key_with_error
- test_tenant_rate_limiting.py: cannot import get_tenant_context

**Missing optional dependency (10):** - BLOCKED
- 10 tests across layer1 and root tests/ (trafilatura, respx, defusedxml, playwright)

**Stale value-fabric path (2):** - BLOCKED
- test_conversation_service.py: imports from services.conversation
- test_entity_contract.py: imports from api.models

**Test fixture issue (4):** - BLOCKED
- 4 layer3-knowledge tests: cannot import TestUtils from tests.conftest

**Unknown import errors (7):** - BLOCKED (needs investigation)
- 3 layer4-agents tests (test_oidc_cleanup.py, test_usage_idempotency.py, test_usage_service.py)
- 1 root tests/ (test_redis_tenant_isolation.py)
