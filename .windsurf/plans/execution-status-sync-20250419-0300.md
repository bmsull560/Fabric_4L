...
**Details**: 
- File: `value-fabric/layer5-ground-truth/tests/test_model_registry.py`
...
- `value-fabric/layer3-knowledge/src/graph_store/migrations/`
- `value-fabric/layer4-agents/src/engine/executor.py`
- `value-fabric/layer5-ground-truth/tests/conftest.py`
...
#### Acceptance Criteria
- [ ] `pytest value-fabric/layer3-knowledge/tests/test_vector_e2e.py` passes
- [ ] `pytest value-fabric/layer4-agents/tests/test_langgraph_execution.py` passes (0 failures)
- [ ] `pytest value-fabric/layer5-ground-truth/tests/test_model_registry.py` passes (0 errors)
...
pytest value-fabric/layer2-extraction/tests/test_extract_and_ingest_pipeline.py -v

# Verify L4 checkpoint/resume
pytest value-fabric/layer4-agents/tests/test_checkpoint_resume.py -v

# Verify L4 workflow controls
pytest value-fabric/layer4-agents/tests/test_workflow_controls.py -v

# Check Model Registry (currently broken)
pytest value-fabric/layer5-ground-truth/tests/test_model_registry.py -v

# Check Vector E2E (currently broken)
pytest value-fabric/layer3-knowledge/tests/test_vector_e2e.py -v
